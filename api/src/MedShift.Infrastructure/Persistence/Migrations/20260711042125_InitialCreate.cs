        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageTh = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirebaseDeviceToken = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLocationLng = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPay = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RequiredSkillsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequiredCertification = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinReliabilityScore = table.Column<double>(type: "float", nullable: false),
                    HiredStaffProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Jobs_StaffProfiles_HiredStaffProfileId",
                        column: x => x.HiredStaffProfileId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffSkills_StaffProfiles_StaffProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_StaffProfiles_StaffProfileId",
                        column: x => x.StaffProfileId,
                        principalTable: "StaffProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleTh = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TitleEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContentTh = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContentEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequiresAcknowledgment = table.Column<bool>(type: "bit", nullable: false),
                    EstimatedReadTimeSeconds = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckInRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CheckInRequirements_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CheckInRequirements_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckInSessions_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobApplications_StaffProfiles_StaffProfileId",
                        column: x => x.StaffProfileId,
                        principalTable: "StaffProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckInRequirements_JobId",
                table: "CheckInRequirements",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckInRequirements_OrganizationId",
                table: "CheckInRequirements",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckInSessions_JobId",
                table: "CheckInSessions",
                column: "JobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeviceTokens_UserId_FirebaseDeviceToken",
                table: "DeviceTokens",
                columns: new[] { "UserId", "FirebaseDeviceToken" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_JobId_StaffProfileId",
                table: "JobApplications",
                columns: new[] { "JobId", "StaffProfileId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_StaffProfileId",
                table: "JobApplications",
                column: "StaffProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_HiredStaffProfileId",
                table: "Jobs",
                column: "HiredStaffProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffSkills_StaffProfileId",
                table: "StaffSkills",
                column: "StaffProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wallets_StaffProfileId",
                table: "Wallets",
                column: "StaffProfileId",
                unique: true);
